...
class ScheduleLifecycleSeparationTests(TestCase):
    ...
    def test_correct_lifecycle_transitions(self):
        ...
        self.assertEqual(self.submission.case_stage, SurveySubmission.CaseStage.SURVEY_IN_PROGRESS)
    ...
    def test_final_schedule_separated_from_working_draft(self):
        ...
        self.submission.refresh_from_db()
        self.assertEqual(self.submission.case_stage, SurveySubmission.CaseStage.SERVICES_IN_PROGRESS)
