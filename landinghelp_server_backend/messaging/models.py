...
class Conversation(models.Model):
    ...
    class WorkspaceType(models.TextChoices):
        HQ_BACKOFFICE = 'HQ_BACKOFFICE', '본사업무방'
        LOCAL_EXECUTION = 'LOCAL_EXECUTION', '현지진행방'
        APPOINTMENT = 'APPOINTMENT', '약속 대화'
        OTHER = 'OTHER', '기타'
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                condition=models.Q(
                    survey_submission__isnull=False,
                    workspace_type='HQ_BACKOFFICE',
                ),
            ...
            models.UniqueConstraint(
                ...
                condition=models.Q(
                    survey_submission__isnull=False,
                    workspace_type='LOCAL_EXECUTION',
                ),
